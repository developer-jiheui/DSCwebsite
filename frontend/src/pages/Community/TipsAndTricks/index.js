...
const TipsAndTricks = () => {
  ...
  useEffect(async () => {
    const posts = await fetch(
      "http://localhost:5000/tipsandtricks/community/tipsandtricks/",
      {
        method: "GET",
        headers: {
  ...
  const loadPosts = async (word = "") => {
    ...
    const posts1 = await fetch(
      "http://localhost:5000/tipsandtricks/community/tipsandtricks/tag/",
      requestOptions
    );
  ...
  const handleSubmit = (e) => {
    ...
    // Post new posting
    fetch(
      "http://localhost:5000/tipsandtricks/community/createpost/",
      requestOptions
    ).then((response) => {
  ...
  const handleSearchChange = async (e) => {
    ...
    const dataset = await fetch(
      "http://localhost:5000/tipsandtricks/community/posting/tipsandtricks/q/",
      requestOptions
    );
      ...
      <Container>
        <ContentContainer>
          ...
          <p className="centered-text">
            Need some advice? Ask a question to your fellow members, or browse
            some of the common Q&As
          </p>
          <Grid columns="3" stackable={false} relaxed>
            <Grid.Column width="4">
              <Button color="purple" onClick={handleOpenCreateModal}>
                Create Post
              </Button>
            </Grid.Column>
              ...
              <Search
                ...
                onResultSelect={(e, data) => {
                  window.location.href =
                    "http://localhost:3000/community/tipsandtricks/" +
                    data.result._id;
                }}
                results={results}
                value={searchValue}
